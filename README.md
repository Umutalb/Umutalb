...
- [Turkish ID Validator](https://github.com/Umutalb/TurkishIDValidator): A Python program to validate Turkish Republic identification numbers using a specific algorithm.
- [Weather App](https://github.com/Umutalb/WeatherApp): A Python-based application that fetches and displays weather data using an API.
